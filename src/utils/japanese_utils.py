...
_JP_NUMBER_MAP: list[tuple[str, str]] = [
    ("100000", "じゅうまん"), ("10000",  "いちまん"), ("1000",   "せん"),
    ("100",    "ひゃく"), ("20",     "にじゅう"), ("30",     "さんじゅう"),
    ("40",     "よんじゅう"), ("50",     "ごじゅう"), ("60",     "ろくじゅう"),
    ("70",     "ななじゅう"), ("80",     "はちじゅう"), ("90",     "きゅうじゅう"),
...
def safe_print(message: str) -> None:
    """Prints text safely, handling potential encoding issues in the console."""
    try:
        print(message)
